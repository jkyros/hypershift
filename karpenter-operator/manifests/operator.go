...
func ReconcileKarpenterOperatorDeployment(deployment *appsv1.Deployment,
	...
	mainContainer := corev1.Container{
		...
		Args: []string{
			...
			"--karpenter-provider-image=" + karpenterProviderImage,
		},
	}
...
func ReconcileKarpenterOperator(ctx context.Context, createOrUpdate upsert.CreateOrUpdateFN, c client.Client, hypershiftOperatorImage, controlPlaneOperatorImage, karpenterProviderImage string, hcp *hyperv1.HostedControlPlane) error {
...
`
	...
	if hcp.Status.KubeConfig != nil {
		...
		_, err = createOrUpdate(ctx, c, deployment, func() error {
			return ReconcileKarpenterOperatorDeployment(deployment, hcp, serviceAccount, kubeConfigSecret, hypershiftOperatorImage, controlPlaneOperatorImage, karpenterProviderImage, setDefaultSecurityContext, ownerRef)
		})
		if err != nil {
