...
func main() {
	...
	rootCmd.PersistentFlags().StringVar(&karpenterProviderImage, "karpenter-provider-image", "", "The image to run the actual platform-specific karpenter provider")
...
func run(ctx context.Context) error {
	...
	r := karpenter.Reconciler{
		...
		KarpenterProviderImage:    karpenterProviderImage,
	}
