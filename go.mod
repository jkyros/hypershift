...
replace github.com/aws/karpenter-provider-aws => github.com/openshift/karpenter-provider-aws v0.0.0-20251113175151-7f0513e0305e
...
replace (
	...
	go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.5.20
	go.etcd.io/etcd/client/v2 => go.etcd.io/etcd/client/v2 v2.305.20
	go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.5.20
	go.etcd.io/etcd/pkg/v3 => go.etcd.io/etcd/pkg/v3 v3.5.20
	go.etcd.io/etcd/raft/v3 => go.etcd.io/etcd/raft/v3 v3.5.20
	go.etcd.io/etcd/server/v3 => go.etcd.io/etcd/server/v3 v3.5.20
	go.etcd.io/etcd/tests/v3 => go.etcd.io/etcd/tests/v3 v3.5.20
)

// Pin Kubernetes dependencies to v0.34.x for OpenShift 4.21 (K8s 1.34)
replace (
